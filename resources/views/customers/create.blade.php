                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pl-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="zela">
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 pr-1">
                                    <div class="form-group">
                                        ...
                                        <select data-trigger="" name="employee" class="form-control" id="meal" onChange="changecat(this.value);">
                                            <option value="রাজনু" selected>রাজনু</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 pl-1">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="Status" id="subt" required>
                                </div>
                            </div>
                            <div class="col-md-4 pl-1">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="payment" value="NULL">
                                </div>
                                <div class="col-md-3 pl-1" style="display:none;">
                                <div class="form-group">
                                    <label>{{ __('paymentmethod') }}</label>
                                     <select data-trigger="" name="paymentmethod" class="form-control" value="{{ __('unpaid')}}">
